...
class MovieListItem extends StatelessWidget {
    ...
    switch (actionStr) {
      case 'coming_soon':
        action = Container(
              ...
              child: Text(pubdate, style: TextStyle(color: Colors.red, fontSize: 12.0),),
        );
        break;
      default:
        action = Column(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          MovieCoverImage(movie.images.small, width: imgWidth, height: height,),
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 10,),
                Text('${movie.year} /${genres2String(movie.genres)}/${actor2String(movie.directors)}/${actor2String(movie.casts)}',
                  style: TextStyle(
                    color: AppColor.grey,
                    fontSize: 14
                  ),
